          ...
          <div class="row">
            <div class="col-sm-6 col-md-6 col-lg-3 mb-sm-4">
              <div class="card text-center bg-light" style="height: 100%;">
                <div class="card-body">
                 <img src="{{ asset('gogo4.jpg') }}" class="w-50 rounded-circle" alt="">
                  <h5 class="card-title mt-3">Christian Go</h5>
            ...
            <div class="col-sm-6 col-md-6 col-lg-3 mb-sm-4">
              <div class="card text-center bg-light" style="height: 100%;">
                <div class="card-body">
                <img src="{{ asset('gogo3.jpg') }}" class="w-50 rounded-circle" alt="">
                  <h5 class="card-title mt-3">Christian Go</h5>
                  <p class="card-text">Lorem ipsum dolor sit amet consectetur adipisicing elit. Voluptas voluptatem repellendus unde veniam eius quia inventore amet dicta? Incidunt, cumque.</p>
                  <i class="fab fa-twitter"></i>&nbsp;
                  <i class="fab fa-facebook-f"></i>&nbsp;
            ...
            <div class="col-sm-6 col-md-6 col-lg-3 mb-sm-4">
              <div class="card text-center bg-light" style="height: 100%;">
                <div class="card-body">
                  <img src="{{ asset('gogo2.jpg') }}" class="w-50 rounded-circle" alt="">
                  <h5 class="card-title mt-3">Christian Go</h5>
                  <p class="card-text">Lorem ipsum dolor sit amet consectetur adipisicing elit. Voluptas voluptatem repellendus unde veniam eius quia inventore amet dicta? Incidunt, cumque.</p>
                  <i class="fab fa-twitter"></i>&nbsp;
                  <i class="fab fa-facebook-f"></i>&nbsp;
            ...
            <div class="col-sm-6 col-md-6 col-lg-3 mb-sm-4">
              <div class="card text-center bg-light" style="height: 100%;">
                <div class="card-body">
                  <img src="{{ asset('gogo1.jpg') }}" class="w-50 rounded-circle" alt="">
                  <h5 class="card-title mt-3">Christian Go</h5>
                  <p class="card-text">Lorem ipsum dolor sit amet consectetur adipisicing elit. Voluptas voluptatem repellendus unde veniam eius quia inventore amet dicta? Incidunt, cumque.</p>
                  <i class="fab fa-twitter"></i>&nbsp;
                  <i class="fab fa-facebook-f"></i>&nbsp;
